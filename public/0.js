...
var _actions2 = __webpack_require__(148);

var _GreetingComponent = __webpack_require__(920);
...
var HomeContainer = _react2.default.createClass({
  ...
  propTypes: {
    requestGreeting: _react.PropTypes.func.isRequired,
    greeting: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.object])
  },
  ...
  render: function render() {
    return _react2.default.createElement(_GreetingComponent2.default, { message: this.props.greeting.content });
  }
});
...
var mapStateToProps = function mapStateToProps(_ref) {
  var greetingReducer = _ref.greetingReducer;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    requestGreeting: function requestGreeting() {
      return dispatch((0, _actions.requestGreeting)());
    },
    requestLogin: function requestLogin() {
      return dispatch((0, _actions2.getToken)());
    }
  };
};
...
var _styles = __webpack_require__(921);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var GreetingComponent = function GreetingComponent(props) {
...
var SubTitle = exports.SubTitle = _styledComponents2.default.p(_templateObject2);
